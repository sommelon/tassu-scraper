    ...
    public static void main(String[] args) {
        ...
        try {
            while (rs.next()) {
                ...
                databaseStarScheme.insertIntoFact(rsDielo.getLong(1), rsPracovisko.getLong(1), rsAutor.getLong(1), rsKategoria.getLong(1), rsCas.getLong(1), isNumeric(rs.getString(13)) ? Long.valueOf(rs.getString(13)) : 1L);
            }
